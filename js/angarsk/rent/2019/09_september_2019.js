    ...
    data: {
        ...
        datasets: [
           //Однокомнатные
         {
            ...
            borderColor: 'gray',
            data: [10710, 11100, 10090, 11300, 11400, 11000, 11200, 10970, 11370, 11140, 10680, 11530],
        ...
        //Двухкомнатные
         {
            ...
            borderColor: '#FF5349',
            data: [12720, 13940, 12600, 12870, 12700, 12800, 12850, 13340, 13260, 13470, 13180, 13330],
            pointBorderColor: '#282828',
        ...
        //Трехкомнатные
           {
            ...
            borderColor: '#FFD800',
            data: [19960, 22290, 21400, 15590, 16130, 17710, 20000, 20330, 15930, 17460, 17710, 18330],
            pointBorderColor: '#282828',
    ...
    data: {
        ...
        datasets: [
           //Однокомнатные
         {
            ...
            backgroundColor: 'rgba(163,179,221,0.4)',
            borderColor: 'gray',
            data: [1330, 1300, 1310, 1320, 1300, 1270, 1260, 1250, 1210, 1180, 1210, 1210],
            pointBorderColor: '#282828',
            pointBackgroundColor: '#F5F5F5',
            pointRadius: 5,
            pointHoverRadius: 5,
        ...
        //Двухкомнатные
         {
            ...
            backgroundColor: 'rgba(246,182,156,0.3)',
            borderColor: '#FF5349',
            data: [1640, 1660, 1680, 1650, 1560, 1570, 1550, 1580, 1530, 1520, 1550, 1500],
            pointBorderColor: '#282828',
            pointBackgroundColor: '#FFDAB9',
            pointRadius: 5,
            pointHoverRadius: 5,
        ...
        //Трехкомнатные
           {
            ...
            backgroundColor: 'rgba(255,255,153,0.2)',
            borderColor: '#FFD800',
            data: [2630, 2330, 2500, 2250, 2250, 1950, 1950, 2100, 2230, 2200, 2100, 2000],
            pointBorderColor: '#282828',
            pointBackgroundColor: '#FFFF66',
            pointRadius: 5,
            pointHoverRadius: 5,
