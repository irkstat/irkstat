    ...
    data: {
        ...
        datasets: [
           //Однокомнатные
         {
            ...
            borderColor: 'gray',
            data: [14640, 14950, 15010, 14900, 14840, 14520, 14920, 14780, 15030, 15120, 15250, 15550],
        ...
        //Двухкомнатные
         {
            ...
            borderColor: '#FF5349',
            data: [18880, 19090, 18680, 19020, 18560, 18390, 18410, 18740, 18340, 19630, 20870, 21430],
            pointBorderColor: '#282828',
        ...
        //Трехкомнатные
           {
            ...
            borderColor: '#FFD800',
            data: [26150, 26070, 27230, 28180, 24820, 25820, 26820, 30110, 28110, 27670, 27670, 29070],
            pointBorderColor: '#282828',
    ...
    data: {
        ...
        datasets: [
           //Однокомнатные
         {
            ...
            backgroundColor: 'rgba(163,179,221,0.4)',
            borderColor: 'gray',
            data: [1330, 1310, 1310, 1320, 1300, 1310, 1310, 1320, 1340, 1340, 1350, 1360],
            pointBorderColor: '#282828',
            pointBackgroundColor: '#F5F5F5',
            pointRadius: 5,
            pointHoverRadius: 5,
        ...
        //Двухкомнатные
         {
            ...
            backgroundColor: 'rgba(246,182,156,0.3)',
            borderColor: '#FF5349',
            data: [1800, 1800, 1780, 1780, 1780, 1790, 1770, 1820, 1810, 1870, 1840, 1820],
            pointBorderColor: '#282828',
            pointBackgroundColor: '#FFDAB9',
            pointRadius: 5,
            pointHoverRadius: 5,
        ...
        //Трехкомнатные
           {
            ...
            backgroundColor: 'rgba(255,255,153,0.2)',
            borderColor: '#FFD800',
            data: [2460, 2510, 2480, 2480, 2460, 2410, 2370, 2460, 2560, 2430, 2440, 2680],
            pointBorderColor: '#282828',
            pointBackgroundColor: '#FFFF66',
            pointRadius: 5,
            pointHoverRadius: 5,
