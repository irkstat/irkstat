    ...
    data: {
        ...
        datasets: [
           //Однокомнатные
         {
            ...
            borderColor: 'gray',
            data: [9590, 10480, 9920, 9260, 9770, 10150, 10270, 9720, 10590, 9840, 11570, 11600],
        ...
        //Двухкомнатные
         {
            ...
            borderColor: '#FF5349',
            data: [12630, 12690, 12380, 12630, 13130, 13640, 12150, 14580, 12940, 14440, 16950, 18900],
            pointBorderColor: '#282828',
        ...
        //Трехкомнатные
           {
            ...
            borderColor: '#FFD800',
            data: [18080, 17700, 17450, 18470, 19040, 14270, 15080, 16920, 17330, 21210, 24730, 24940],
            pointBorderColor: '#282828',
    ...
    data: {
        ...
        datasets: [
           //Однокомнатные
         {
            ...
            backgroundColor: 'rgba(163,179,221,0.4)',
            borderColor: 'gray',
            data: [1170, 1190, 1190, 1150, 1170, 1120, 1200, 1170, 1230, 1290, 1280, 1300],
            pointBorderColor: '#282828',
            pointBackgroundColor: '#F5F5F5',
            pointRadius: 5,
            pointHoverRadius: 5,
        ...
        //Двухкомнатные
         {
            ...
            backgroundColor: 'rgba(246,182,156,0.3)',
            borderColor: '#FF5349',
            data: [1600, 1570, 1580, 1470, 1500, 1520, 1520, 1560, 1730, 1720, 1920, 1830],
            pointBorderColor: '#282828',
            pointBackgroundColor: '#FFDAB9',
            pointRadius: 5,
            pointHoverRadius: 5,
        ...
        //Трехкомнатные
           {
            ...
            backgroundColor: 'rgba(255,255,153,0.2)',
            borderColor: '#FFD800',
            data: [2100, 2120, 2210, 2090, 2010, 2020, 2160, 2160, 2090, 2260, 2280, 2250],
            pointBorderColor: '#282828',
            pointBackgroundColor: '#FFFF66',
            pointRadius: 5,
            pointHoverRadius: 5,
