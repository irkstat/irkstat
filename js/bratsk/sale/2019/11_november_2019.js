...
var bratskApartmentPrimaryScale = new Chart(ctx, {
   ...
   data: {
      ...
      datasets: [{
         ...
         data: [34730, 36760, 35760, 36460, 36590, 37400, 38620, 39100, 37950, 38260, 36610, 37430],
...
var bratskApartmentSecondaryScale = new Chart(ctx, {
   ...
   data: {
      ...
      datasets: [{
         label: 'Стоимость кв.м.',
         data: [37040, 36980, 37850, 38310, 38700, 38670, 39390, 39590, 40330, 41440, 42480, 43090],
...
var bratskGarageFerroconcreteScale = new Chart(ctx, {
   ...
   data: {
      ...
      datasets: [{
         label: 'Стоимость кв.м.',
         data: [8140, 8330, 7900, 8800, 8070, 8040, 8210, 7880, 8760, 8570, 8610, 8660],
         backgroundColor: 'gray',
         borderColor: '#293133',
         borderWidth: 1,
      }]
...
var bratskGarageBrickScale = new Chart(ctx, {
   ...
   data: {
      ...
      datasets: [{
         label: 'Стоимость кв.м.',
         data: [9120, 8050, 9020, 8100, 9130, 8420, 8150, 8090, 8270, 8310, 8680, 9790],
         backgroundColor: '#ab7d5c',
         borderColor: '#293133',
         borderWidth: 1,
      }]
...
var bratskEarthSettlementsScale = new Chart(ctx, {
   ...
   data: {
      ...
      datasets: [{
         label: 'Стоим. сотки',
         data: [42690, 34370, 25870, 35200, 35160, 31280, 35430, 34180, 37880, 39410, 34040, 37320],
         backgroundColor: 'gray',
         borderColor: '#293133',
         borderWidth: 1,
      }]
...
var bratskEarthIndustrialScale = new Chart(ctx, {
   ...
   data: {
      ...
      datasets: [{
         label: 'Стоим. сотки',
         data: [112150, 94090, 79970, 70740, 102060, 91820, 99450, 76930, 84390, 82360, 74600, 99180],
         backgroundColor: '#ab7d5c',
         borderColor: '#293133',
         borderWidth: 1,
      }]
...
var bratskEarthAgriculturalScale = new Chart(ctx, {
   ...
   data: {
      ...
      datasets: [{
         label: 'Стоим. сотки',
         data: [11050, 11120, 9600, 10440, 12000, 8420, 9640, 9330, 9730, 10420, 10770, 12670],
...
var bratskHouseBlockScale = new Chart(ctx, {
   ...
   data: {
      ...
      datasets: [{
         label: 'Стоимость кв.м.',
         data: [31420, 25000, 21960, 18100, 20380, 28330, 22980, 23410, 26400, 29730, 28940, 28390],
         backgroundColor: 'gray',
         borderColor: '#293133',
         borderWidth: 1,
      }]
...
var bratskHouseTimberScale = new Chart(ctx, {
   ...
   data: {
      ...
      datasets: [{
         label: 'Стоимость кв.м.',
         data: [20210, 21550, 22400, 21490, 23450, 23820, 24620, 24110, 24730, 25160, 25940, 25910],
         backgroundColor: '#ab7d5c',
         borderColor: '#293133',
         borderWidth: 1,
      }]
...
var bratskHouseBrickScale = new Chart(ctx, {
   ...
   data: {
      ...
      datasets: [{
         label: 'Стоимость кв.м.',
         data: [26200, 25530, 25500, 26900, 25550, 24760, 25830, 28030, 26930, 25810, 27070, 28400],
         backgroundColor: '#BAAF96',
         borderColor: '#293133',
         borderWidth: 1,
      }]
