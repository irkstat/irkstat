...
var usolyeApartmentSecondaryScale = new Chart(ctx, {
   type: 'bar',
   data: {
      labels: ['07.19', '08.19', '09.19', '10.19', '11.19', '12.19', '01.20', '02.20', '03.20'],
      datasets: [{
         label: 'Стоимость кв.м.',
         data: [ 28480, 28750, 29180, 28890, 29500, , , ,],
...
var usolyeEarthSettlementsScale = new Chart(ctx, {
   ...
   data: {
      ...
      datasets: [{
         label: 'Стоим. сотки',
         data: [ 33870, 39250, 43840, 45680, 40590, , , ,],
         backgroundColor: 'gray',
         borderColor: '#293133',
         borderWidth: 1,
      }]
...
var usolyeEarthIndustrialScale = new Chart(ctx, {
   ...
   data: {
      ...
      datasets: [{
         label: 'Стоим. сотки',
         data: [ 117690, 130080, 145360, 199190, 106970, , , ,],
         backgroundColor: '#ab7d5c',
         borderColor: '#293133',
         borderWidth: 1,
      }]
...
var usolyeEarthAgriculturalScale = new Chart(ctx, {
   ...
   data: {
      ...
      datasets: [{
         label: 'Стоим. сотки',
         data: [ 15880, 17030, 17410, 17840, 16040, , , ,],
...
var usolyeHouseBlockScale = new Chart(ctx, {
   ...
   data: {
      ...
      datasets: [{
         label: 'Стоимость кв.м.',
         data: [ 29380, 33550, 35710, 33710, 33530, , , ,],
         backgroundColor: 'gray',
         borderColor: '#293133',
         borderWidth: 1,
      }]
...
var usolyeHouseTimberScale = new Chart(ctx, {
   ...
   data: {
      ...
      datasets: [{
         label: 'Стоимость кв.м.',
         data: [ 23320, 25540, 27390, 26750, 26850, , , ,],
         backgroundColor: '#ab7d5c',
         borderColor: '#293133',
         borderWidth: 1,
      }]
...
var usolyeHouseBrickScale = new Chart(ctx, {
   ...
   data: {
      ...
      datasets: [{
         label: 'Стоимость кв.м.',
         data: [ 30580, 29840, 30950, 29200, 29600, , , ,],
         backgroundColor: '#BAAF96',
         borderColor: '#293133',
         borderWidth: 1,
      }]
